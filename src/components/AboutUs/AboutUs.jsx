        ...
        <div className={styles.about__content}>
          <div className={styles.about__square}>
            ...
            <p className={styles.about__square__description}>
              Our engineering, mechanical and electrical teams are working on
              the relocation of the complete production lines and factories
              inside of the same facility or on completely different locations.
            </p>
          </div>
          <div className={styles.about__square}>
            <svg
          ...
          <div className={styles.about__square}>
            ...
            <p className={styles.about__square__description}>
              Provided to our esteemed customers through designing and
              consulting with partners and paying particular attention to
              choosing the type and method of installation of the heating and
              ventilation system
            </p>
          </div>
          ...
          <div className={styles.about__square}>
            ...
            <p className={styles.about__square__description}>
              Over 250 workers in the mechanical installations sector, among
              which there are 30 engineers who improve their enormous experience
              and knowledge every day at construction sites throughout the world
            </p>
          </div>
